...
public:
    ...
    */
    ...
    HashMap(InputIt start, InputIt end, size_t bucket_count = kDefaultBuckets, const H& hash = H());
...
private:
    ...
    */
    ...
    /*
     * First key-value pair in table
     */
    HashMap::node* firstKV();
    ...
    */
    ...
    iterator make_iterator(node* ptr);
